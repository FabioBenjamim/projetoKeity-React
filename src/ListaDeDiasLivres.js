                ...
                <div className="row">
                    <div className="col-6">
                        <table className="table agenda-meio fundo-lista">
                            ...
                            <CorpoListaLivre redirect={ this.redirect }  livres={this.state.livre} nome={this.props.location.state.nome} idConsultorio={this.props.location.state.idConsultorio} idPaciente={this.props.location.state.idPaciente} />
